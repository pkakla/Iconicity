...
timeline.push({
  ...
  stimulus: `
     <div style="text-align:left; max-height:500px; overflow-y:auto; padding:10px; border:1px solid #ccc; font-family: Times, serif; font-size: 14px; width:60%; margin-left:20%;">
      ...
      <p><b>What you will do:</b> You will see some images of alien beings and will be asked to categorize them.</p>
      ...
      <p><b>Ending your participation:</b> You can choose whether or not to participate in this study. If you decide to participate now but change your mind later,<br>
